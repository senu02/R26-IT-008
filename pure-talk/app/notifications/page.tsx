...
import { Bell, Heart, MessageCircle, UserPlus, Info, Check, CheckCircle2, Loader2 } from 'lucide-react';
import Sidebar from '@/components/Home/Sidebar';
import { notificationsAPI, type NotificationItem, getImageUrl } from '@/lib/api';
                      ...
                      >
                        ...
                        <div className="relative shrink-0">
                          {notif.type === 'system' ? (
                            ...
                            <img 
                              src={getImageUrl(notif.sender_avatar) || PLACEHOLDER_AVATAR} 
