  ...
  return (
    <>
      <div className={`${theme.surface.glass} ${theme.surface.border} rounded-2xl transition-all duration-300 overflow-hidden`}>
        ...
        {/* Action Buttons */}
        <div className="flex items-center justify-around py-1.5 px-2 border-t border-white/5 gap-1">
          <button
            onClick={handleLike}
            disabled={isLiking}
            className={`flex items-center justify-center space-x-2 flex-1 py-2 rounded-xl transition-all duration-200 ${
              liked 
                ? 'text-rose-500 bg-rose-500/15 font-bold shadow-[0_0_12px_rgba(244,63,94,0.3)]' 
                : 'text-rose-400/80 hover:text-rose-400 hover:bg-rose-500/10 font-medium'
            } disabled:opacity-50 disabled:cursor-not-allowed`}
          >
            <svg className="w-5 h-5 transition-transform group-hover:scale-110" fill={liked ? "currentColor" : "none"} stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            ...
            className={`flex items-center justify-center space-x-2 flex-1 py-2 rounded-xl transition-all duration-200 ${
              isCommenting 
                ? 'text-sky-400 bg-sky-500/15 font-bold shadow-[0_0_12px_rgba(56,189,248,0.3)]' 
                : 'text-sky-400/80 hover:text-sky-300 hover:bg-sky-500/10 font-medium'
            }`}
          >
          ...
          <button
            ...
            className="flex items-center justify-center space-x-2 flex-1 py-2 rounded-xl text-emerald-400/80 hover:text-emerald-300 hover:bg-emerald-500/10 font-medium transition-all duration-200"
          >
